...
def run():
    ...
    while True:
        ...
        # Command to append content to a file
            ...
            content = take_command()
            file_handel.append_to_file(filename, content)
        
        # Command to delete a file
        elif 'delete the file' in command:
            speak("Which file do you want to delete?")
            filename = take_command()
            file_handel.delete_file(filename)
            ...
            speak("Goodbye!")
            add_history.store_conversations_in_db(history)  # Store entire conversation history to the database
            return 2
            break
